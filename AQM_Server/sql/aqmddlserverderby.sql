...
CREATE TABLE "APP"."SENSORDRONE_READING" ("DEVICEID" VARCHAR(32) NOT NULL, "DATETIME" TIMESTAMP NOT NULL, "CO2DEVICEID" VARCHAR(32), "CODATA" INTEGER, "CO2DATA" INTEGER, "PRESUREDATA" INTEGER, "TEMPDATA" INTEGER, "HUMIDITYDATA" INTEGER, "GEOLATITUDE" DOUBLE, "GEOLONGITUDE" DOUBLE, "GEOMETHOD" VARCHAR(16));
...
ALTER TABLE "APP"."SENSORDRONE_READING" ADD CONSTRAINT "SERVER_PUSH_EVENT" PRIMARY KEY ("DEVICEID", "DATETIME");
