...
public class AspiraGUI extends javax.swing.JFrame {
	
    public AspiraGUI(String title){
        super(title);
    ...
    public class AspiraGUICloseListener extends WindowAdapter {
        public void windowClosing(WindowEvent e) {
            if (JOptionPane.showConfirmDialog(AspiraGUI.this,
                    "Are you sure you want to exit? Any unsaved changes will be lost!",
                    "Confirm Exit", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)
                    != JOptionPane.YES_OPTION) {
                return;
            }
            AspiraGUI.thisFrame.dispose();
        }
    }	
        ...
        sButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(AspiraGUI.this, 
