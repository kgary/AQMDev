...
CREATE TABLE "APP"."PARTICLEREADING" ("DEVICEID" VARCHAR(16) NOT NULL, "PATIENTID" VARCHAR(16) NOT NULL, "READINGTIME" TIMESTAMP NOT NULL, "SMALLPARTICLE" INTEGER NOT NULL, "LARGEPARTICLE" INTEGER, "GEOLATITUDE" VARCHAR(16), "GEOLONGITUDE" VARCHAR(16), "GEOMETHOD" VARCHAR(16), "GROUPID" INTEGER);
